...
import { NewProjectData, UpdateProjectInfo, AddUserToProject, ChangeMemberRole } from '../types/projecttypes';
...
export const updateMemberRole = async (projectId: string, userId: string, data: ChangeMemberRole) => {
